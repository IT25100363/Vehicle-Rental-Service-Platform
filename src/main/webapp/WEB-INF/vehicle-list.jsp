...
<body>
    <div class="header">
        ...
        <div>
            ...
            <a href="vehicles?action=new" class="btn btn-primary"><i class="fas fa-plus"></i> Add Vehicle</a>
        </div>
    </div>
        ...
        <tbody>
            <c:forEach var="v" items="${listVehicle}">
                <tr>
                    ...
                    <td>${v.model}</td>
                    <td>${v.plateNumber}</td>
                    <td>LKR ${v.rentalPricePerDay}</td>
                    <td>${v.status}</td>
                    <td class="actions">
                        <a href="vehicles?action=edit&id=${v.id}"><i class="fas fa-edit"></i></a>
                        <a href="vehicles?action=delete&id=${v.id}" onclick="return confirm('Delete this vehicle?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
